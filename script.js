...
const homeli = React.createElement(
  "li",
  { id: "home", style: { color: "white", width: "25%" } },
  "Home"
);
const aboutli = React.createElement(
  "li",
  { id: "about", style: { color: "white", width: "25%" } },
  "About"
);
const serviceli = React.createElement(
  "li",
  { id: "service", style: { color: "white", width: "25%" } },
  "Service"
);
const contactusli = React.createElement(
  "li",
  { id: "contact_us", style: { color: "white", width: "25%" } },
  "Contact us"
);

//ul tag where the li tags have been inserted
const navul = React.createElement(
  "ul",
  {
    style: {
      listStyleType: "none",
